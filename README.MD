...
FD1にフロッピーをセットしていなくても起動できますが、autoexec.bat/autoexec.comを読もうとして「Device I/O Error」が出ます。
...
X1/turbo/Z、MZ-700/1500共に互換BIOS(ROM)及び互換フォントが存在するために実機を持っていなくてもエミュレータで楽しめます。
